			...
			<div class="head-view">
				...
				<transition name="star-move">
					<div class="favorite" @click="favoriteFn">
						<i class="iconfont icon-likefill" :class="favor ? 'favor' : 'nofavor'"></i>
						<span>{{collect}}</span>
					</div>
				</transition>
			</div>
    ...
    export default {
        ...
        methods: {
            async initDate() {
                ...
                //这里根据后端传过来的数据中的seller下的supports组数，对应着下面的class属性 背景样式
...
<style lang="stylus" rel="stylesheet/stylus">
    ...
    .seller
    	...
    	.bulletin
    		padding: 18px 18px 0px 18px; text-align: left;
    		& > h1
    			margin-bottom: 10px; line-height: 16px; font-size: 16px; color: rgb(7, 17, 27);
    		.content
